...
public class linkState {
	...
	public static void main(String[] args) {
		...
		linkState psFrame = new linkState();
	...
	public void ReadTextfileToBuildGraph() {
		try
		{
			...
			FileReader fr = new FileReader("plaintext.txt");           //Creation of FileReader object 
			...
			fr = new FileReader("plaintext.txt");                    //Read the content of file into the FileReader object    
			val=new String();
	...
	public linkState() {
		...
		while (true){
			...
			System.out.println("------------------------------------------------------------\n");
			System.out.println("Select your choice :\n------------\n1. Start Link state routing\n \n2. Show Connection Table of routers\n \n3. Shortest Path to Destination Router \n \n4. Exit\n");	
